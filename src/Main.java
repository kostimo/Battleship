...
//        System.out.println(player1.getBoard().placeShip(bs1));
//        System.out.println(player1.getBoard().placeShip(bs2));
//        System.out.println(player1.getBoard().placeShip(bs3));
//        System.out.println(player1.getBoard().placeShip(d1));
//        System.out.println(player1.getBoard().placeShip(d2));
//
